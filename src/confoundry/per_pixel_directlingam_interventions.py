...
mode : {"counterfactual", "interventional_mean"}, default="counterfactual"
    Causal evaluation mode.

intervention : tuple of (scenario, variable, value_spec), optional
...
mechanism : tuple of (scenario, edge, mechanism_spec), optional
...
goal_seek : tuple of (scenario, variable, target, goal_spec), optional
...
climatology_by : str, default="month"
...
event_aggregation : {"none", "mean", "median", "sum"}, default="mean"
...
point_matrix : {"raw", "consensus", "bootstrap_mean"}, default="consensus"
...
allow_new_edges : bool, default=False
...
output_table : str, default="pixel_directlingam_interventions"
    Name of the main output table in ``output_db``.

components_table : str, default="pixel_directlingam_intervention_components"
...
figure_height : float, default=8.0
    Built-in map height in inches.

plot_dpi : int, default=600
...
jobs : int, default=max(1, cpu_count - 1)
