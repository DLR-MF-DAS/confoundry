"""Run per-pixel intervention analyses for DirectLiNGAM SCMs.

See `docs/per_pixel_directlingam_interventions.md` for the full command-line
reference, model notes, output schema, and examples.
"""
